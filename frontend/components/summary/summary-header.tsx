...
export default function SummaryHeader({ createdAt,readingTime,title }: { createdAt: Date,readingTime:number,title:string }) {
    return (
        <div className="flex gap-4 mb-4 justify-between">
            <div className="space-y-6">
                <div className="flex flex-wrap items-center gap-4">
                    <Badge
                        variant='secondary'
                        className="relative px-4 py-1.5 text-sm font-medium bg-white/80 backdrop-blur-xs rounded-full shadow-xs hover:bg-white/90 transition-all duration-200 hover:shadow-md"
                    >
                        <Sparkles className="h-4 w-4 mr-2 text-rose-500" />
                        AI summary
                    </Badge>
                    <div className="flex items-center gap-2 text-sm text-muted-foreground">
                        <Calendar className="h-5 w-5 inline-block  text-rose-400" />
                    ...
                    <div className="flex items-center gap-2 text-sm text-muted-foreground">
                        <Clock className="h-5 w-5 inline-block  text-rose-400" />
